...
Write-Host "Start a new PowerShell window under administrator context. Please prepare an user credential who has local administrator priviledge.`n" -ForegroundColor Yellow
Start-Sleep 1
...
Write-Host "Please compress [C:\AAD_Logs] folder and send us." -ForegroundColor Yellow
